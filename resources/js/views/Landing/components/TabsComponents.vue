  ...
  >
    <div class="flex flex-col">
      ...
      <div class="flex items-center whitespace-nowrap">
        ...
        <img
          ...
          class="mx-3"
        />
        <h2 class="text-xs font-bold ml-5">Return -</h2>
    ...
    <div>
      <div class="flex flex-col ml-20">
        <h2 class="text-xs font-bold mb-3">Vehicle</h2>

        <!-- Si Tabs2 está disponible, muestra la imagen y el nombre -->
        <div class="flex items-center" v-if="Tabs2">
          <img :src="Tabs2.image_path" :alt="Tabs2.title" class="w-20 h-auto" />
        ...
        <div v-else>
          <h2 class="text-base text-gray-400">Not yet</h2>
          <span class="text-xs text-gray-400">Select a Vehicle </span>
        </div>
      </div>
    </div>
    <div class="flex flex-col">
    ...
    <div>
      <h2 class="text-xs text-gray-300">review</h2>
    </div>
  </section>
</template>
