<template>
  <section class="lg:ml-64 p-4">
    ...
    <div v-if="isModalOpen" class="modal-overlay" @click.self="closeModal">
      <div class="modal-content  mb-4 bg-orange-50 w-full px-7 py-4">
        <!-- Título del modal -->
        ...
        <div class="mb-4  bg-orange-50 w-full px-7">
          ...
          <div class="flex items-center mt-2">
            ...
            <!-- Información adicional de fecha y hora -->
            <div>
        ...
        <div class="mb-4 bg-orange-50 w-full px-7">
          <!-- Título del Vehículo -->
          <h3 class="font-semibold text-orange-600 text-sm">Vehículo</h3>

          <!-- Información del Vehículo -->
          <div class="flex items-center mt-2">
            <!-- Imagen del vehículo -->
            <img
              :src="selectedReservation.url_vehicle"
              alt="Vehicle"
            ...
            <div class="flex flex-col ">
              ...
              <h2 class="text-sm font-bold">
                {{ selectedReservation.vehicle.name }}
              </h2>

              <!-- Contenedor para iconos y números -->
              <div class="flex gap-4 mt-2">
                <!-- Icono y número de personas -->
                <div class="flex items-center space-x-1">
                  <img
                    src="./Landing/asset/User.png"
                    alt="usuario"
                    width="19"
                    height="18"
                  />
                  <span class="text-xs">{{
                    selectedReservation.number_person
                  }}</span>
                </div>

                <!-- Icono y número de maletas -->
                <div class="flex items-center space-x-1">
                  <img
                    src="./Landing/asset/bag.png"
                    alt="maleta"
                    width="19"
                    height="18"
                  />
                  <span class="text-xs">{{
                    selectedReservation.number_bag
                  }}</span>
                </div>
              </div>
            </div>
